...
public class FCoupledSimulator implements FSimulator
{
    ...
    public void inputInjected()  				{simulator.inputInjected();}
    ...
    public class FRTCentralCoordX extends SimViewCoordinator
    {
        ...
        */
        ...
        public synchronized void simulate(int numIterations)
        {
            ...
            if (numIterations > 0)
            {
                if (currentState == STATE_INITIAL || currentState == STATE_PAUSE|| currentState == STATE_END)
                {
        ...
        public void run()
        {
            ...
            while (!stopRequested) {
                ...
                int i = 1;
                tN = nextTN();
               // System.out.println("ahanda çalýþtý");
