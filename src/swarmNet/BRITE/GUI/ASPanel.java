...
public final class ASPanel extends JPanel implements ActionListener {
  ...
  public void ConvertFileToBriteFormat() {
    ...
    swarmNet.BRITE.Util.Util.MSG("Converting AS import file to BRITE..");
    
    String briteFile=file+".brite";
    if (extFormat.equals("nlanr")) {
    	swarmNet.BRITE.Import.NLANRImport im = new swarmNet.BRITE.Import.NLANRImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }
    else if (extFormat.equals("gtitm")) {
    	swarmNet.BRITE.Import.GTImport im = new swarmNet.BRITE.Import.GTImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }    
	...
	//      Util.Util.ERR("Transit-Stub can only be imported at router level..");
      ...
      //im.convert(briteFile);
    	...
    	swarmNet.BRITE.Import.SkitterImport im = new swarmNet.BRITE.Import.SkitterImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }
    else if (extFormat.equals("inet")) {
    	swarmNet.BRITE.Import.InetImport im = new swarmNet.BRITE.Import.InetImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }   
    else if (extFormat.equals("scan")) {
    	swarmNet.BRITE.Import.SCANImport im = new swarmNet.BRITE.Import.SCANImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }   
    else {
