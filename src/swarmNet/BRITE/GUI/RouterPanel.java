...
public final class RouterPanel extends JPanel  implements ActionListener {
 ...
 /** converts import format to brite format and returns name of new file. */
  public void ConvertFileToBriteFormat() {
    ...
    swarmNet.BRITE.Util.Util.MSG("Converting Router-level import file to BRITE..");
    
    String briteFile=file+".brite";
    if (extFormat.equals("nlanr")) {
    	swarmNet.BRITE.Import.NLANRImport im = new swarmNet.BRITE.Import.NLANRImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.RT_FILE);
	im.convert(briteFile);
    }
    else   if (extFormat.equals("gtitm")) {
    	swarmNet.BRITE.Import.GTImport im = new swarmNet.BRITE.Import.GTImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.RT_FILE);
      im.convert(briteFile);
    }    
    else if (extFormat.equals("gtts")) {
    	swarmNet.BRITE.Import.GTTSImport im = new swarmNet.BRITE.Import.GTTSImport(new File(convertFilename));
      im.convert(briteFile);
    }
    else if (extFormat.equals("skitter")) {
    	swarmNet.BRITE.Import.SkitterImport im = new swarmNet.BRITE.Import.SkitterImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.RT_FILE);
      im.convert(briteFile);
    }
    else if (extFormat.equals("inet")) {
    	swarmNet.BRITE.Import.InetImport im = new swarmNet.BRITE.Import.InetImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.RT_FILE);
      im.convert(briteFile);
    }   
    else if (extFormat.equals("scan")) {
    	swarmNet.BRITE.Import.SCANImport im = new swarmNet.BRITE.Import.SCANImport(new File(convertFilename), swarmNet.BRITE.Model.ModelConstants.RT_FILE);
      im.convert(briteFile);
    }   
    else {
