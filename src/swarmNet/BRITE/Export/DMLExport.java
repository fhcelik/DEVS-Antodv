...
import swarmNet.BRITE.Model.ASModel;
...
import swarmNet.BRITE.Model.RouterModel;
...
public class DMLExport {
  ...
  public void export() {
	...
	FileModel f = new FileModel(swarmNet.BRITE.Import.ImportConstants.BRITE_FORMAT, briteFile, ModelConstants.RT_FILE); 
	...
	format = ModelConstants.AS_FILE;
      ...
      FileModel f = new FileModel(swarmNet.BRITE.Import.ImportConstants.BRITE_FORMAT, briteFile, format); 
      Topology t = new Topology(f);
