...
import swarmNet.BRITE.Export.DEVSExport;
import swarmNet.BRITE.Export.DMLExport;
import swarmNet.BRITE.Export.JSimExport;
import swarmNet.BRITE.Export.NSExport;
import swarmNet.BRITE.Export.OtterExport;
...
final public class Brite { 
  ...
  public static Topology getTopology(){
	...
	System.out.println("\tConnected");
	  ...
	  be.export();
	  swarmNet.BRITE.Visualizer.Visualize.ciz(outFile+".brite");
      }
	 ...
	 ne.export();
       ...
       if (exportFormats.contains("DEVS-Suite")) {
    		 ...
    		 DEVSExport ne = new DEVSExport(t, new File("src/swarmNet/"+outFile+".java"));
    		 ne.export();
    	       }
