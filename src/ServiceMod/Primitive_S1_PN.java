...
import GenService.ServiceRouter;
    ...
    {
        preferredSize = new Dimension(670, 590);
        ((ViewableComponent)withName("USZip")).setPreferredLocation(new Point(391, 118));
        ((ViewableComponent)withName("BrokerTransd")).setPreferredLocation(new Point(190, 25));
        ((ViewableComponent)withName("Resort")).setPreferredLocation(new Point(374, 245));
        ((ViewableComponent)withName("VoiceComm")).setPreferredLocation(new Point(287, 428));
        ((ViewableComponent)withName("ResortTransd")).setPreferredLocation(new Point(427, 191));
        ((ViewableComponent)withName("USZipTransd")).setPreferredLocation(new Point(431, 64));
        ((ViewableComponent)withName("Broker")).setPreferredLocation(new Point(160, 80));
        ((ViewableComponent)withName("Subscriber1")).setPreferredLocation(new Point(-9, 214));
        ((ViewableComponent)withName("Router Link")).setPreferredLocation(new Point(195, 214));
        ((ViewableComponent)withName("Sub1Transd")).setPreferredLocation(new Point(9, 158));
        ((ViewableComponent)withName("VoiceCommTransd")).setPreferredLocation(new Point(280, 364));
        ((ViewableComponent)withName("RouterTransd")).setPreferredLocation(new Point(192, 157));
    }
}
