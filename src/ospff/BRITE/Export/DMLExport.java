...
import ospff.BRITE.Model.ASModel;
import ospff.BRITE.Model.BottomUpHierModel;
import ospff.BRITE.Model.FileModel;
import ospff.BRITE.Model.ModelConstants;
import ospff.BRITE.Model.RouterModel;
import ospff.BRITE.Model.TopDownHierModel;
...
public class DMLExport {
  ...
  public void export() {
	...
	FileModel f = new FileModel(ospff.BRITE.Import.ImportConstants.BRITE_FORMAT, briteFile, ModelConstants.RT_FILE); 
	...
	format = ModelConstants.AS_FILE;
      ...
      FileModel f = new FileModel(ospff.BRITE.Import.ImportConstants.BRITE_FORMAT, briteFile, format); 
      Topology t = new Topology(f);
