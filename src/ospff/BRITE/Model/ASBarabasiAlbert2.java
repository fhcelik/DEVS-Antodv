...
public  class ASBarabasiAlbert2 extends ASBarabasiAlbert {
  ...
  public ASBarabasiAlbert2(int N, int HS, int LS,  int nodePlacement, int m, int bwDist,
  ...
  public Graph Generate() {
    ...
    /*  public static void main(String args[]) {
      ASBarabasiAlbert2 rb = new      ASBarabasiAlbert2(9200, 1000, 1000, 1, 2, 1, (double)10.0,
