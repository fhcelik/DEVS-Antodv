...
public class networEF extends ViewableDigraph {

public networEF(){
    super("SAMPLE SWARM NETWORK 1");
    ViewableDigraph swnt = new networ("Network",1,1);
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("Network")).setPreferredLocation(new Point(278, 166));
