...
public class EventGenerator extends ViewableAtomic {
  ...
  public EventGenerator() {this("EventGenr", 1);}
...
/*   addTestInput("start", new doubleEnt(10));
   addTestInput("start", new doubleEnt(150));
   addTestInput("start", new doubleEnt(5));*/
   addTestInput("start", new doubleEnt(0.05));
   addTestInput("start", new doubleEnt(1));
   addTestInput("start", new doubleEnt(0.1));
//   addTestInput("stop",new entity("1000"));
  }
