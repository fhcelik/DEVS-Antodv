...
import honeycomb.BRITE.Export.DEVSExport;
import honeycomb.BRITE.Export.DMLExport;
import honeycomb.BRITE.Export.JSimExport;
import honeycomb.BRITE.Export.NSExport;
import honeycomb.BRITE.Export.OtterExport;
...
final public class Brite { 
  ...
  public static Topology getTopology(){
	...
	System.out.println("\tConnected");
	  ...
	  be.export();
	  honeycomb.BRITE.Visualizer.Visualize.ciz(outFile+".brite");
      }
	 ...
	 ne.export();
       ...
       if (exportFormats.contains("DEVS-Suite")) {
    		 ...
    		 DEVSExport ne = new DEVSExport(t, new File("src/honeycomb/"+outFile+".java"));
    		 ne.export();
    	       }
