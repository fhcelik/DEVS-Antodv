...
public final class ASPanel extends JPanel implements ActionListener {
  ...
  public void ConvertFileToBriteFormat() {
    ...
    honeycomb.BRITE.Util.Util.MSG("Converting AS import file to BRITE..");
    
    String briteFile=file+".brite";
    if (extFormat.equals("nlanr")) {
    	honeycomb.BRITE.Import.NLANRImport im = new honeycomb.BRITE.Import.NLANRImport(new File(convertFilename), honeycomb.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }
    else if (extFormat.equals("gtitm")) {
    	honeycomb.BRITE.Import.GTImport im = new honeycomb.BRITE.Import.GTImport(new File(convertFilename), honeycomb.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }    
	...
	//      Util.Util.ERR("Transit-Stub can only be imported at router level..");
      ...
      //im.convert(briteFile);
    	...
    	honeycomb.BRITE.Import.SkitterImport im = new honeycomb.BRITE.Import.SkitterImport(new File(convertFilename), honeycomb.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }
    else if (extFormat.equals("inet")) {
    	honeycomb.BRITE.Import.InetImport im = new honeycomb.BRITE.Import.InetImport(new File(convertFilename), honeycomb.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }   
    else if (extFormat.equals("scan")) {
    	honeycomb.BRITE.Import.SCANImport im = new honeycomb.BRITE.Import.SCANImport(new File(convertFilename), honeycomb.BRITE.Model.ModelConstants.AS_FILE);
      im.convert(briteFile);
    }   
    else {
