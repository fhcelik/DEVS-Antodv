...
public final class StatusDialog extends JDialog implements ActionListener {
    ...
    honeycomb.BRITE.GUI.Brite parent =null;
    ...
    public StatusDialog(honeycomb.BRITE.GUI.Brite parent) {
	super();
	super.dialogInit();
	//	setSize(400,400);
	setResizable(true);
