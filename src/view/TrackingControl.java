...
public class TrackingControl {
	...
	public void showTrackerSettingsDialog(FModel model)
    {
        findTrackerFor(model).showDialogPanel();
    }
    ...
    public void registerTimeView(ArrayList graphs, final int num, String XLabel, String TimeIncre) {    	
		...
		if(!View.isBreakout) //BREAK OUT CONTROLS
		{
			//Add a tab		
		...
		{		
            ...
            public void run() {
            	javax.swing.JFrame frame=new javax.swing.JFrame(modelColumn[num].getAttachedModel().getName());
            	frame.setDefaultCloseOperation(javax.swing.JFrame.DISPOSE_ON_CLOSE);
            	frame.getContentPane().add(timeView[num].retTG(), BorderLayout.CENTER);
            	frame.pack();
