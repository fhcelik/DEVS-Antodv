...
{    
    ...
    public static final String FRAME_TITLE = "DEVS_Suite Ver 2.0";
    
    /**Image Paths*/
    public static final String SPLASH_SCREEN_ICON = "/graphics/splash.gif";
    ...
    public static final String TOP  			  = "/graphics/top.png";
